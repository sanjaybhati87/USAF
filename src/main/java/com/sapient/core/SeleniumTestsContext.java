...
import com.sapient.driver.TestType;
import com.sapient.reporter.PluginsHelper;

/**
 * Defines TestNG context used in STF.S
 * @author ssi248
 *
 */
public class SeleniumTestsContext {
    ...
    public static final String HTML_REPORT_LOGGING="hmlreportlogging";
    ...
    public static final String  CLINENT_TYPE = "clientType";
    ...
    Map<String, Object> contextDataMap = Collections.synchronizedMap(new HashMap<String, Object>());
    ...
    public SeleniumTestsContext(final ITestContext context) {
        ...
        setContextAttribute(context, EXPLICIT_WAIT_TIME_OUT, System.getProperty(EXPLICIT_WAIT_TIME_OUT), "100");
        ...
        setContextAttribute(context, HTML_REPORT_LOGGING, System.getProperty(HTML_REPORT_LOGGING), "true");
        setContextAttribute(context, TEST_RETRY_COUNT, System.getProperty(TEST_RETRY_COUNT), "0");
        ...
        setContextAttribute(context, USER_NAME, System.getProperty(USER_NAME), null);
        setContextAttribute(context, PASSWORD, System.getProperty(PASSWORD), null);
        setContextAttribute(context, REGION, System.getProperty(REGION), "Europe");
        setContextAttribute(context, COUNTRY, System.getProperty(COUNTRY), "United Kingdom");
        setContextAttribute(context, CLINENT_TYPE, System.getProperty(CLINENT_TYPE), "INSTITUTIONAL");
    ...
    public int getRetryCount() {
    	int retry;
        try {
    	 retry=Integer.parseInt((String)getAttribute(TEST_RETRY_COUNT)); ;
        }
        catch (Exception e)
        {
        	retry=0;
    ...
    public String getWebRunBrowser() {
    	System.out.println(getAttribute(BROWSER));
    ...
    public int getBrowserHeight() {
        try {
            return Integer.parseInt((String) getAttribute(BROWSER_HEIGHT));
        } catch (Exception e) {
            return 780; // Default
        }
    }
    ...
    public int getBrowserWidth() {
        try {
            return Integer.parseInt((String) getAttribute(BROWSER_WIDTH));
        } catch (Exception e) {
            return 1320; // Default
        }
    }
    ...
    public String getClinetType() {
        return (String) getAttribute(CLINENT_TYPE);
    }
    ...
    public boolean isHtmlReportLoggingEnabled() {
        try {
            return Boolean.parseBoolean((String) getAttribute(HTML_REPORT_LOGGING));
        } catch (Exception e) {
            return false; // Default
        }
    }
    ...
    public void setRetryCount(final String retryCount) {
        setAttribute(TEST_RETRY_COUNT, retryCount);
    }
