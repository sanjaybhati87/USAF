...
import com.sapient.helper.ContextHelper;
...
public class HtmlElement {
    ...
    public void click() {
    	...
    	{
    		logger.error("Error while finding the element by locater:"+" " +by.toString());
    	}
    }
    ...
    protected void findElement() {
        ...
        logger.info("Find the element with locater:"+" "+by.toString());
    	}
    	catch(Exception e)
    	{
    		logger.error("Error while finding the element by locater:"+" " +by.toString());
    ...
    public Dimension getSize() {
        findElement();
        TestLogging.log("Get the size of the element under test, So width and height can be verified");
