...
@objects
	...
	text-section                       xpath     //div[@class="wrapper insight-article"]/div
	...
	insights-*                        xpath          //div[@class="owl-item"]
...
=Hero component=
    @on *
		...
		heading:
		   ...
		   text contains "Monthly Commentary US and European banks: Stronger than you may think"
