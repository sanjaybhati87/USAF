 ...
 *
 *//*
public class FundsLitraturePage  extends PageObject{
	
private static final ImageElement logo = new ImageElement("Wellington logo", parser.getLocator("HomePage_logo"));
	
	public FundsLitraturePage(final boolean openPageURL) throws Exception {
		super(username,openPageURL ? SeleniumTestsContextManager.getThreadContext().getAppURL() : null,"FundsLitraturePage");
	...
	public void doLogin()
	{
		...
		pauseExecutionFor(10000);
		driver.navigate().to("http://wellington-dev.kurtosysdev.com/uk/en/intermediary/funds-literature/");
