 ...
 *
 *//*
public class RegionalHomePage extends PageObject {
	
	private static final ImageElement logo = new ImageElement("Wellington logo", parser.getLocator("HomePage_logo"));
	
	
	public RegionalHomePage(final boolean openPageURL) throws Exception {
		super(username,openPageURL ? SeleniumTestsContextManager.getThreadContext().getAppURL() : null,"HomePostAttestation");
	...
	public boolean isLogoDisplayed()
	{
		...
		pauseExecutionFor(10000);
		driver.navigate().to("http://wellington-dev.kurtosysdev.com/uk/en/intermediary/");
