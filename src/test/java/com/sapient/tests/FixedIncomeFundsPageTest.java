 ...
 *
 */
public class FixedIncomeFundsPageTest extends SeleniumTestPlan{
	...
	public void verifyClickOnViewAllFixedIncomeFundLink() throws NotCurrentPageException
	{
		loginPage = new LoginPage(driver);
		 ...
		 fundExplorer= fixedIncomeFundsPage.clikOnviewallFixedIncomeFundsLink();
	...
	public void verifyClickOnExploreInsightLink() throws NotCurrentPageException
	{
		loginPage = new LoginPage(driver);
		 ...
		 fixedIncomeFundsPage=fundsLanding.clickOnfixedIncomeFundLink();
		 CustomAssertion.assertEquals(fixedIncomeFundsPage.getTitle(),"Wellington Management Funds – Fixed income funds",  "User is not navigated to Fixed income funds page after clicking on Fixed income fund link");
		 allInsightPage= fixedIncomeFundsPage.clikOnexploreallInsightsLink();
